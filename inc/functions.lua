...
msg.KeyboardCmd = list_settings
msg.textmsg = "🙋‍♂ - اهلا بك عزيزي في  لستة الاوامر n\ ✅ - الان يمكنك قفل وفتح الاعدادات n\ عبر الضغط على الازرار n\ ✅ تعني مفتوح n\ ❌ تعني مقف"
msg.Editeinline = true
return SendMsgInline(msg)
end
...
list_settings = list_settings:gsub('true', '{✅}')
list_settings = list_settings:gsub('false', '{❌}')
msg.textmsg = "🙋‍♂ - اهلا بك عزيزي في  لستة الاوامر ✅ - الان يمكنك قفل وفتح الوسائط عبر الضغط على الازرار✅ تعني مفتوح❌ تعني مقفل"
msg.KeyboardCmd = list_settings
msg.Editeinline = true
return SendMsgInline(msg)
end
...
list_settings = list_settings:gsub('true', '{✅}')
list_settings = list_settings:gsub('false', '{❌}')
msg.textmsg = "🙋‍♂ - اهلا بك عزيزي في  لستة الاوامر ✅ - الان يمكنك تفعيل وتعطيل الاعدادات عبر الازرار✅ تعني مفتوح❌ تعني مقف"
msg.KeyboardCmd = list_settings
msg.Editeinline = true
return SendMsgInline(msg)
end
...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 879123322 or msg.sender_user_id_ == 1281716337 then 
Adminn = true
...
download_file('https://raw.githubusercontent.com/kkkbk/LHB/main/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/kkkbk/LHB/main/inc/locks.lua','./inc/locks.lua')
...
result = false
if msg.sender_user_id_ == 879123322 or msg.sender_user_id_ == 1281716337 then 
SudoBase = true
...
var = 'هذا البوت' 
elseif UserID == 879123322or UserID == 1281716337 then 
var = 'مطور البوت '
...
elseif UserID == 1281716337 or UserID == 879123322 then 
...
if UserID == 1281716337 or UserID == 879123322 then return sendMsg(ChatID,MsgID,"- لا يمكنك تنفيذ الامر ضد مطور البوت ❕") end
