...
if msg.sender_user_id_ == 00090 or msg.sender_user_id_ == 1718587141  then 
...
if (msg.text=="تحديث" or msg.text=="we" or msg.text=="تحديث ♻️") and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 00090 or msg.sender_user_id_ == 1718587141) then
return sendMsg(msg.chat_id_,msg.id_,"- تم تحديث الملفات",function(arg,data)
Refresh_Start = true
end)
end 
if msg.text == 'Update Source' and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 00090 or msg.sender_user_id_ == 1718587141) then
UpdateSource(msg)
